...
--input "input/SensorDataReport.csv" --output "output" \
--batch_interval 0.1 --batch_size 10 --source_file_extension "csv" \
--prefix "SensorDataReport_" --output_header False --output_index True \
...
if __name__ == "__main__":
    ...
    ap.add_argument("-i", "--input", required=False, type=str, default='input/SensorDataReport.csv',
                    help="Input data path. Default: ./input/SensorDataReport.csv")
